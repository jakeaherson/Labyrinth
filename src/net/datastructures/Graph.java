...
public interface Graph<V,E> {
   ...
   * @throws IllegalArgumentException if v is not a valid vertex
   */
  Iterable<Edge<E>> incomingEdges(Vertex<V> start2) throws IllegalArgumentException;
  ...
  Vertex<V> opposite(Vertex<V> start2, Edge<E> e) throws IllegalArgumentException;
