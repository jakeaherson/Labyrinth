...
public class NodePositionList<E> implements PositionalList<E> {
	//end#fragment Header
	...
	public Iterable<Position<E>> positions() {     // create a list of posiitons
		PositionalList<Position<E>> P = new NodePositionList<Position<E>>();
		if (!isEmpty()) {
			Position<E> p = first();
			while (true) {
	...
	public static <E> String forEachToString(PositionalList<E> L) {
		String s = "[";
		int i = L.size();
		for (E elem: L) {
