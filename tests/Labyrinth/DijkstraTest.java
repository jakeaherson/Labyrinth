...
public class DijkstraTest {
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(0,3), new RoomCoordinate(3,1) );
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(1,1), new RoomCoordinate(2,2) );
		LinkedList<Edge<Walkway>> lPath = Util.toList(pathIterable);
		Edge<Walkway> lEdge = null;
		int lCorrectEdges = 0;
		int lCurrentEdge = 0;
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(2,2), new RoomCoordinate(1,3) );
		LinkedList<Edge<Walkway>> lPath = Util.toList(pathIterable);
		Edge<Walkway> lEdge = null;
		int lCorrectEdges = 0;
		int lCurrentEdge = 0;
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(3,3), new RoomCoordinate(1,0) );
		LinkedList<Edge<Walkway>> lPath = Util.toList(pathIterable);
		Edge<Walkway> lEdge = null;
		int lCorrectEdges = 0;
		int lCurrentEdge = 0;
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(2,3), new RoomCoordinate(0,2) );
		LinkedList<Edge<Walkway>> lPath = Util.toList(pathIterable);
		Edge<Walkway> lEdge = null;
		int lCorrectEdges = 0;
		int lCurrentEdge = 0;
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(6,3), new RoomCoordinate(5,6) );
		LinkedList<Edge<Walkway>> lPath = Util.toList(pathIterable);
		Edge<Walkway> lEdge = null;
		int lCorrectEdges = 0;
		int lCurrentEdge = 0;
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(2,1), new RoomCoordinate(3,4) );
		LinkedList<Edge<Walkway>> lPath = Util.toList(pathIterable);
		Edge<Walkway> lEdge = null;
		int lCorrectEdges = 0;
		int lCurrentEdge = 0;
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(4,2), new RoomCoordinate(1,3) );
		LinkedList<Edge<Walkway>> lPath = Util.toList(pathIterable);
		Edge<Walkway> lEdge = null;
		int lCorrectEdges = 0;
		int lCurrentEdge = 0;
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(0,6), new RoomCoordinate(6,0) );
		LinkedList<Edge<Walkway>> lPath = Util.toList(pathIterable);
		Edge<Walkway> lEdge = null;
		int lCorrectEdges = 0;
		int lCurrentEdge = 0;
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(5,0), new RoomCoordinate(2,2) );
		LinkedList<Edge<Walkway>> lPath = Util.toList(pathIterable);
		Edge<Walkway> lEdge = null;
		int lCorrectEdges = 0;
		int lCurrentEdge = 0;
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(12,6), new RoomCoordinate(9,3) );
		LinkedList<Edge<Walkway>> lPath = Util.toList(pathIterable);
		Edge<Walkway> lEdge = null;
		int lCorrectEdges = 0;
		int lCurrentEdge = 0;
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(11,1), new RoomCoordinate(1,4) );
		LinkedList<Edge<Walkway>> lPath = Util.toList(pathIterable);
		Edge<Walkway> lEdge = null;
		int lCorrectEdges = 0;
		int lCurrentEdge = 0;
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(4,9), new RoomCoordinate(5,3) );
		LinkedList<Edge<Walkway>> lPath = Util.toList(pathIterable);
		Edge<Walkway> lEdge = null;
		int lCorrectEdges = 0;
		int lCurrentEdge = 0;
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(0,2), new RoomCoordinate(9,9) );
		LinkedList<Edge<Walkway>> lPath = Util.toList(pathIterable);
		Edge<Walkway> lEdge = null;
		int lCorrectEdges = 0;
		int lCurrentEdge = 0;
		...
		Walkway[] lWalkways = 
    {
		...
		;
		Iterable<Edge<Walkway>> pathIterable = TARGET.shortestPath( new RoomCoordinate(13,0), new RoomCoordinate(2,2) );
		LinkedList<Edge<Walkway>> lPath = Util.toList(pathIterable);
		Edge<Walkway> lEdge = null;
		int lCorrectEdges = 0;
		int lCurrentEdge = 0;
